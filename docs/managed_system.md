...
# Extension with our base class

[This package](../ros_ws/src/python_base_class) contains the base class that will be used by every node in the managed subsystem.
For examples how to use the base class follow the instructions in the next section.

## Communication configuration

An example on how to configure the communication for a node added to the system is shown in [here](../ros_ws/src/managed_subsystem/managed_subsystem/config/camera_config.py)
